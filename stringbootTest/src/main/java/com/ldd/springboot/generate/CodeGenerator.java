...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 选择 freemarker 模板引擎，默认 Veloctiy
        mpg.setTemplateEngine(new FreemarkerTemplateEngine());
        //配置自定义模板
//        TemplateConfig templateConfig = new TemplateConfig().setEntity("Template.java");
...
//        gc.setEntityName("%sEntity");            //实体命名方式  默认值：null 例如：%sEntity 生成 UserEntity
        ...
        dsc.setUrl("jdbc:mysql://39.105.110.72:3306/springboot?characterEncoding=UTF-8");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.ldd.springboot");
